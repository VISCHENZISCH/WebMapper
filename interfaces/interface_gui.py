...
def vp_start_gui():
    ...
    prog_location = os.path.dirname(os.path.abspath(__file__))
    root = tk.Tk()
    top = Toplevel1 (root)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        photo_location = os.path.join(prog_location, "icon/logo.png")
        global _img0
        ...
        photo_location = os.path.join(prog_location, "icon/scan.png")
        global _img1
        ...
        photo_location = os.path.join(prog_location, "icon/stop.png")
        global _img2
